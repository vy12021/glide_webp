...
public class WebpDrawableTransformation implements Transformation<WebpDrawable> {
  ...
  @NonNull
  @Override
  public Resource<WebpDrawable> transform(
      @NonNull Context context, @NonNull Resource<WebpDrawable> resource,
    ...
    // modify the dimensions of our WEBP, here we create a stand in for a frame and pass it to the
